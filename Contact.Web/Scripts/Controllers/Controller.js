...
app.controller('crudController', function ($scope, crudService) {
    ...
    //Function to load all Contact records
    function loadRecords() {
        var promiseGet = crudService.GetContacts(); //The MEthod Call from service

        promiseGet.then(function (pl) { $scope.Contact = pl.data },
              function (errorPl) {
                  $log.error('failure loading Contacts', errorPl);
              });
    }
